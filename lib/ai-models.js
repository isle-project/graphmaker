 ...
 * @param {object} options - options for the AI model
 * @param {string} options.type - whether to use a memoryless or serial chat
 * @param {string} options.model - the name of the model to use
 * @returns {function} function that can be used to generate LLM completions
 */
