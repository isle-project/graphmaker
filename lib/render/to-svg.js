...
function drawNode({ node, position, canvas, baseSize, styles, key, isDraft }) {
    ...
    const shape = nodeStyle.nodeShape;
    const size = nodeStyle.nodeSize;
    ...
    switch ( shape ) {
        case 'circle':
            ...
            drawNodeLabel({ node, position, canvas, key, nodeStyle, hSize: baseSize/2, vSize: baseSize/2, isDraft });
            break;
        case 'square':
        ...
        case 'rectangle':
            ...
            drawNodeLabel({ node, position, canvas, key, nodeStyle, hSize: node.widthToHeight * baseSize/2, vSize: baseSize/2, isDraft });
            break;
        case 'ellipse':
