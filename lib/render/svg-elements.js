...
const diamond = (cx, cy, width, height, styles = {}) => {
    const myStyles = projectStyle(styles, 'diamond');
    const points = [
        [cx, cy - height / 2],
        [cx + width / 2, cy],
        [cx, cy + height / 2],
...
const triangle = (cx, cy, r, styles = {}) => {
    const myStyles = projectStyle(styles, 'triangle');
