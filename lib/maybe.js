...
const Maybe = {
    ...
    nothing: (() => {
        ...
        Object.setPrototypeOf( obj, MaybeType.prototype );
        return obj; })(),
...
MaybeType.prototype.toString = function maybeToString() {
...
if ( isNode ) {
    ...
    MaybeType.prototype[util.inspect.custom] = function inspectMaybe(depth, options) {
