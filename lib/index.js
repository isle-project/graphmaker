 ...
 * @property {Object} graph - the current graph
 * @property {Array<Object>} history - record of past tasks and commands
 * @property {number} historyIndex - current position in the history
 * @property {Object} config - current configuration map
 */
...
async function updateGraphConvert( state, config ) {
    const { format = 'json', draft = false } = config; // eslint-disable-line no-unused-vars
